      ...
      <div class="popup-body">
        ...
        <div class="popup-content">
          ...
          <div class="css-79elbk">
            ...
            <div class="css-1pbcwnc">
              <div class="css-jq41fl"></div>
            </div>
            <div class="css-bwa3g6">
              <div class="css-ox858j">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                  <g transform="rotate(180,12,12)">
                    <path d="M12 2L4.5 20.29l.71.71L12 18l6.79 3 .71-.71z" fill="hsl(211, 8%, 10%)"></path>
                  </g>
                </svg>
              </div>
            </div>
                  ...
                  <svg width="100" height="100" class="css-0 e1jniu8c0">
                    <g style="
                      ...
                      <path
                        ...
                        stroke-width="12" stroke="hsl(210, 12%, 93%)" class="css-1c0mkoe e1jniu8c2"></path>
                      <path
                        d="M 19.3582222752 24.2884956125 A 40.0000000000 40.0000000000 0 1 1 19.3582222752 75.7115043875"
                        stroke-width="8" stroke="rgba(102, 102, 102, 1)" class="css-1c0mkoe e1jniu8c2"
                        stroke-dashoffset="0px" stroke-dasharray="1.9548309326171855px 195.48309326171875px"></path>
                    </g>
                  </svg>
                </div>
                <div class="css-1cklb6d">
                  <p class="css-181krat">1.1</p>
                </div>
                <div class="css-rk55iw">
                  <p class="css-17frgt3">km/h</p>
                </div>
              </div>
        ...
        <div class="css-1pzn42j">
          ...
          <button type="button" class="popup-action-btn" @click="redirectToHello">แดชบอร์ดสถานี</button>
        </div>
      </div>
    </div>
  </div>
